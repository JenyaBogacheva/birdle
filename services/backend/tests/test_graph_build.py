...
class TestCompiledGraph:
    async def test_non_bird_short_circuits_to_final(self):
        ...
        with patch.object(N, "_first_text", return_value="NO"), patch.object(N, "_raw_anthropic") as raw:
    ...
    async def test_happy_path_reaches_submit(self):
        ...
        with patch.object(N, "_first_text", return_value="YES"), \
            ...
            teb.get_regional_birds = AsyncMock(
                return_value={"region": "US-NY", "species_observed": [{"common_name": "Northern Cardinal"}]}
            )
